...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'vehicle.create': {
    roles: ['vehicle-owner', 'performance-analyst', 'reservation-manager'],
  ...
  'usage.update': {
    ...
    tenantPath: ['organization', 'user', 'vehicle', 'usage'],
    userPath: [],
  },
  'reservation.create': {
    roles: ['vehicle-owner', 'reservation-manager'],
...
const tenantRoles: string[] = ['administrator', 'vehicle-owner', 'performance-analyst', 'reservation-manager'];
